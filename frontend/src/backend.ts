...
export class Backend implements backendInterface {
    ...
    async getAllPlayers(): Promise<Array<PlayerRanking>> {
        if (this.processError) {
            try {
    ...
    async getMaxRankedPoints(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getMaxRankedPoints();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPlayer(arg0: string): Promise<PlayerRanking | null> {
        if (this.processError) {
            try {
    ...
    async getPlayerRankByRanking(arg0: string): Promise<PlayerRanking | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getPlayerRankByRanking(arg0);
                return from_candid_opt_n6(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRankingCategories(): Promise<RankingGroup> {
        if (this.processError) {
            try {
                const result = await this.actor.getRankingCategories();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRankingCategory(): Promise<RankingGroup> {
        if (this.processError) {
            try {
                const result = await this.actor.getRankingCategory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRankingEntryCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getRankingEntryCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRawRankingData(): Promise<RawRankingData> {
        if (this.processError) {
            try {
                const result = await this.actor.getRawRankingData();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchPlayersByName(arg0: string): Promise<Array<PlayerRanking>> {
        if (this.processError) {
            try {
    ...
    async switchRankingCategory(arg0: RankingGroup): Promise<RankingGroup> {
        if (this.processError) {
            try {
                const result = await this.actor.switchRankingCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PlayerRanking]): PlayerRanking | null {
    return value.length === 0 ? null : value[0];
}
